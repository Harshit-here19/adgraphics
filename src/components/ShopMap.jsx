...
export default function ShopMap() {
  ...
  return (
    <div className={`max-w-4xl mx-auto my-12 p-6 bg-linear-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-xl transition-all duration-700 ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2 animate-fade-in-up">Visit Our Store</h2>
        <p className="text-gray-600 animate-fade-in-up-delay-1">Ad Graphics - Sanjay Palace, Agra</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 animate-fade-in-up-delay-2">
              ...
              <Popup minWidth={200}>
                <div className="p-2 animate-fade-in">
                  ...
                  <div className="mt-4 flex gap-2 animate-fade-in-up-delay-1">
                    <button className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-3 rounded-lg text-sm font-medium transition duration-300 flex items-center justify-center transform hover:-translate-y-0.5 hover:shadow-md">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      Call Now
                    </button>
                    <button className="flex-1 bg-rose-500 hover:bg-rose-600 text-white py-2 px-3 rounded-lg text-sm font-medium transition duration-300 flex items-center justify-center transform hover:-translate-y-0.5 hover:shadow-md">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className={`p-5 bg-linear-to-r from-indigo-500 to-purple-600 text-white transition-all duration-1000 ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className={`mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 transition-all duration-1000 delay-300 ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
